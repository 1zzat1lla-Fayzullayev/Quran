    ...
    <>
      <div className="relative">
        <input
          ...
          className="relative border pr-[48px] border-[#091d22] rounded-[6px] outline-none pl-[15px] py-[7px] w-full text-white bg-transparent text-[15px] md:text-[20px]"
        />
        <i class="bx bx-user absolute right-3 text-[25px] text-[#a4a8a8] top-[25%]"></i>
      </div>
      <div className="relative">
        <input
          type="text"
