...
function Card({ surah }) {
  return (
    <>
      <div className="card bg-[#1f2125] w-[300px] md:w-[350px] h-[80px] border border-[#464b50] cursor-pointer rounded-[6px] hover:border-[#2ca4ab] flex font-Poppins">
        ...
        <div className="ml-[20px] flex items-center justify-between w-full">
          <div>
            ...
            <p className="text-[#343a40] text-[12px] onBlue-p">
